...
export const InterviewerUpdate = () => {
  ...
  const handleUpdate = (event) => {
    ...
    if(interviewer.department_id==""){
      const response = setError({department_id:"The name field is required."});
      return response;
    }

    if(interviewer.position_id==""){
      const response = setError({position_id:"The name field is required."});
      return response;
    }
    ...
    <div className="card-min">
      ...
      <form onSubmit={handleUpdate} className="card-min__form">
       ...
       {error.name && (
        ...
        />
        {error[2] && (
           <span className="txt-danger txt-ss">{error[2]}</span>
        )}
        ...
        />
        {error[3] && (
           <span className="txt-danger txt-ss">{error[3]}</span>
        )}
...
//           labelName="Position"
//           options={positions}
//           selectedValue={console.log(interviewer.position_id==1)}
//           onChange={(e) =>
//             setInterviewer({ ...interviewer, position_id: e.target.value })
//           }
//           errorMessage="*"
